...
#ifndef OBIBUF_CORE_H
#define OBIBUF_CORE_H
...
/* Version Information */
#define OBIBUF_VERSION_MAJOR 1
#define OBIBUF_VERSION_MINOR 0
#define OBIBUF_VERSION_PATCH 0
...
typedef enum {
    ...
    OBI_ERROR_DFA_TRANSITION_FAILED,
    OBI_ERROR_CANONICAL_FORM_INVALID
} obi_result_t;
...
typedef struct {
    ...
    bool normalized;
    bool validated;
    uint8_t pattern_hash[OBI_HASH_SIZE];
} obi_buffer_t;
